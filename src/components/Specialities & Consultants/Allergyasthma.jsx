...
import asth1 from '../../Assets/banner/Banner-Template_counsellor-1.jpg'
    ...
    return (
        <>
            ...
            <div className="inner-asth">
                <div className="asth-banner">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 order-last order-lg-first">
                                <div className="banner-left1">
                                    <img src={asth1} alt="asth" />
                                    <div className="boxe">
                                        <div className="card-content">
                                            <h1>Allergy & Asthma</h1>
                                            <p>
                                                Allergies and asthma, two conditions that usually occur together and
                                                affect the patient gravely. These two conditions have many symptoms
                                                and side effects in common.
                                            </p>
                                            <p>
                                                The same substance that may trigger your allergic reactions and
                                                symptoms, such as pollen dust, pet dander, etc., may also be the
                                                reason behind the appearance of asthma-related signs and symptoms.
                                                In some people, skin or food-related allergies may be instrumental in
                                                causing asthma symptoms. This condition can also be termed as
                                                allergic asthma or allergy-induced asthma.
                                            </p>
                                        </div>
